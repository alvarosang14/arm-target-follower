...
class FollowMeHeadExecution(yarp.RFModule):
    ...
    def configure(self, rf):
        ...
        self.iControlMode = self.headDevice.view(yarp.IControlMode)
        self.iEncoders = self.headDevice.view(yarp.IEncoders)
        ...
        if self.iControlMode is None or self.iEncoders is None or self.iPositionControl is None:
